...
#                         "safe_navigation_confidence": float,
...
#             # ===============================
#             # FUSED DECISION (ONLY THIS IS USED BY NAV)
#             # ===============================
#             "fused_decision": {
#                 "status": "completed",
#                 "timestamp": float,
#                 "data": {
#                     "overall_safety_level": "safe" | "caution_required" | "unsafe",
#                     "recommended_action": str,
#                     "max_combined_risk": float,

#                     "action_decisions": {
#                         "move_forward": {
#                             "decision": "proceed" | "stop" | "proceed_with_caution",
